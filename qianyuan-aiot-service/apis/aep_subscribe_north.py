...
#  描述:
def GetSubscriptionsList(appKey, appSecret, productId, pageNow, pageSize, MasterKey, subType, searchValue, deviceGroupId):
    path = '/aep_subscribe_north/subscribes'
    head = {}
    param = {'productId':productId, 'pageNow':pageNow, 'pageSize':pageSize, 'subType':subType, 'searchValue':searchValue, 'deviceGroupId':deviceGroupId}
...
#参数body: 类型json, 参数不可以为空
#  描述:body,具体参考平台api说明
def CreateDestHttpUrl(appKey, appSecret, MasterKey, body):
